...
cat("Error de prueba:", percent(test_error), "\n")
```
...
cat("Error de entrenamiento:", percent(train_error), "\n")
```
...
-   A continuación se presenta una tabla estatica que puede variar dependiendo de la ejecución. Los datos aquí presentes son en la ejecución del 2023-05-14 05:14 p.m.

| Modelo                   | Error datos desbalanceados Prueba | Error datos balanceados Entrenamiento |
|-------------------|-------------------------|----------------------------|
| Random Forest Tidymodels | 26.62%                            | 19.62%                                |
| XGBoost                  | 25.97%                            | 37.38%                                |
| Random Forest H2o        | 30.51%                            | 23.13%                                |

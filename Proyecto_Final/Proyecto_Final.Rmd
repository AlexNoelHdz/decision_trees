...
Con la función skim es posible ver que el número de datos que se tienen es de 768, así como un recap de algunas métricas.

```{r}
skim_data  <- skim(data)
knitr::kable(skim_data)
```
...
```{r}
datos_balanced <- downSample(data_clean[, -1], data_clean$Outcome) # submuestrear la clase mayoritaria
datos_balanced
